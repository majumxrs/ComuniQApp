            ...
            <View style={css.caixamaior}>
                ...
                <View style={css.container}>
                    ...
                    <RNPickerSelect
                        ...
                        items={[
                            { label: 'testwe', value: 1 },
                            { label: 'TEste para Id teste', value: 2 },
                            { label: 'TEste para Id teste 02', value: 3 },
                        ]}
                    />
                    ...
                    <RNPickerSelect
                        ...
                        items={[
                            { label: 'Tenso', value: 1 },
                            { label: 'Para Teste de Id', value: 2 },
                            { label: 'Para Teste de Id 012', value: 3 },
                        ]}
                    />
